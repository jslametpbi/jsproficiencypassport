...
## Final v9 Audio Control Update

- Diagnosis uses a 60-item diagnostic format: Listening 12, Structure 12, Reading 12, Vocabulary 12, Writing 6, and Speaking 6.
- Diagnosis, Practice, and Mock Listening items include three visible controls: **Play Audio**, **Replay Audio**, and **Stop Audio**.
- Real Test Listening uses official one-time audio: each listening item has **Play Audio Once** and locks immediately after use. Replay and stop are not available in the real test for security.
- Real Test remains institutional ITP-style: Listening 50 items / 35 minutes, Structure and Written Expression 40 items / 25 minutes, Reading Comprehension 50 items / 55 minutes.


## v9 Reading Fix
- Added full reading passages for Diagnostic Reading, Mock Reading, Practice Reading Lab, and all 50 Real Test Reading items.
- Reading items now render passage cards before each question set.
- Answer choices are styled as clickable buttons/labels and fully integrated with scoring.
- Browser cache busting added through `app.js?v=9` and `styles.css?v=9`.
